...
/***/ function(module, exports, __webpack_require__) {
	...
	var Wrap = (function (_Component2) {
		...
		Wrap.prototype.shouldComponentUpdate = function shouldComponentUpdate() {
			console.log('Wrap: shouldComponentUpdate');
			return _Component2.prototype.shouldComponentUpdate.call(this);
		};
		...
		Wrap.prototype.render = function render() {
			...
			return _react2['default'].createElement(Counter, { ref: 'counter', count: this.state.count, COUNT: this.actions.COUNT });
		};
